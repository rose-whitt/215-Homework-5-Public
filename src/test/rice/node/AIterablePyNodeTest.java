...
/**
 * Helper functions for testing some of the iterable node types.
 */
public abstract class AIterablePyNodeTest extends APyNodeTest {
     ...
     */
    protected static <InnerType extends APyObj> PyTupleNode<InnerType>
    convertListNodeToTup(PyListNode<InnerType> node) {
     ...
     * PyListNodes
     */
    protected static <InnerType extends APyObj> PyTupleNode<PyTupleObj<InnerType>>
    convertNestedListNodeToTup(PyListNode<PyListObj<InnerType>> node) {
     ...
     */
    protected static <InnerType extends APyObj> Map<PyTupleObj<InnerType>, Double>
    convertMapOfListObjs(Map<PyListObj<InnerType>, Double> map) {
     ...
     */
    protected static <InnerType extends APyObj> Set<PyTupleObj<InnerType>>
    convertListObjsToTuples(Collection<PyListObj<InnerType>> set) {
     ...
     */
    protected static <InnerType extends APyObj> Set<PyTupleObj<PyTupleObj<InnerType>>>
    convertNestedListObjsToTuples(Set<PyListObj<PyListObj<InnerType>>> set) {
     ...
     */
    protected static <InnerType extends APyObj> PyTupleObj<PyTupleObj<InnerType>>
    convertNestedListObjsHelper(PyListObj<PyListObj<InnerType>> obj) {
